...
public class RemediationInstruction implements Parcelable
{
    ...
    /**
     * Read a &lt;remediationinstructions&gt; element and store the extracted RemediationInstruction objects in the given list.
     *
     * @param parser
     * @param instructions
    ...
    /**
     * Read an &lt;instruction&gt; element and store the information in the given RemediationInstruction object.
     *
     * @param parser
     * @param instruction
     * @throws XmlPullParserException
    ...
    /**
     * Read all items of an &lt;items&gt; node and add them to the given RemediationInstruction object.
     *
     * @param parser
     * @param instruction
     * @throws XmlPullParserException
