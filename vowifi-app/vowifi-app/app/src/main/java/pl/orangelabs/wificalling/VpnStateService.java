...
public class VpnStateService extends Service
{
	...
	public static final String VPN_ERROR_STATE = "vpn_error_state";
	...
	public void onCreate()
	{
		...
		mBroadcastHelper = new BroadcastHelper(VpnStateService.this);
	}
	...
	private void sendUpdateState()
	{
		...
		extra.putInt(VPN_STATE, getState().ordinal());
		extra.putInt(VPN_ERROR_STATE, getErrorState().ordinal());
		mBroadcastHelper.sendMessage(IpsecpMsg.STATE_CHANGE, extra);
	}
	/**
		...
		notifyListeners(new Callable<Boolean>() {
			...
			public Boolean call() throws Exception
			{
				if (VpnStateService.this.mError != error)
				{
					...
					VpnStateService.this.mState = State.ERROR;
					return true;
				}
				return false;
			}
