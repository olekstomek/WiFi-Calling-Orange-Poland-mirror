...
public class FastScroller
{
    ...
    public FastScroller(Context context, FastScrollRecyclerView recyclerView, AttributeSet attrs)
    {
        ...
        try
        {
            ...
            int
                popupTextSize =
                typedArray.getDimensionPixelSize(R.styleable.FastScrollRecyclerView_fastScrollPopupTextSize, Utils.toScreenPixels(resources, 56));
            int
                popupBackgroundSize =
                typedArray.getDimensionPixelSize(R.styleable.FastScrollRecyclerView_fastScrollPopupBackgroundSize, Utils.toPixels(resources, 88));
        ...
        mHideRunnable = () -> {
            if (!mIsDragging)
            {
                ...
                mAutoHideAnimator =
                        ObjectAnimator.ofInt(FastScroller.this, "offsetX", (Utils.isRtl(mRecyclerView.getResources()) ? -1 : 1) * mWidth);
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener()
        {
            ...
            {
//                ParallaxRecyclerView parallaxRecyclerView = (ParallaxRecyclerView) recyclerView;
//                parallaxRecyclerView.handleExternalScroll(dy);
//                 super.onScrolled(recyclerView, dx, dy);
    ...
    public void draw(Canvas canvas)
    {
        ...
        //Background
        canvas.drawRect(mThumbPosition.x + mOffset.x, mThumbHeight / 2 + mOffset.y, mThumbPosition.x + mOffset.x + mWidth,
            mRecyclerView.getHeight() + mOffset.y - mThumbHeight / 2, mTrack);

        //Handle
        canvas.drawRect(mThumbPosition.x + mOffset.x, mThumbPosition.y + mOffset.y, mThumbPosition.x + mOffset.x + mWidth,
