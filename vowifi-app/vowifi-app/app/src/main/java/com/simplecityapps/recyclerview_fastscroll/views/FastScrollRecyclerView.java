...
public class FastScrollRecyclerView extends RecyclerView implements RecyclerView.OnItemTouchListener
{
    ...
    /**
     * The current scroll state of the recycler view.  We use this in onUpdateScrollbar() and scrollToPositionAtProgress() to determine the scroll
     * position of the recycler view so that we can calculate what the scroll bar looks like, and where to jump to from the fast scroller.
     */
    ...
    /**
     * We intercept the touch handling only to support fast scrolling when initiated from the scroll bar.  Otherwise, we fall back to the default
     ...
     *
     * @param yOffset
     *     the offset from the top of the recycler view to start tracking.
     */
    ...
    /**
     * Updates the scrollbar thumb offset to match the visible scroll of the recycler view.  It does this by mapping the available scroll area of the
     * recycler view to the available space for the scroll bar.
     *
     * @param scrollPosState
     *     the current scroll position
     * @param rowCount
     *     the number of rows, used to calculate the total scroll height (assumes that all rows are the same height)
     * @param yOffset
     *     the offset to start tracking in the recycler view (only used for all apps)
     */
...
//        layoutManager.scrollToPosition(spanCount * exactItemPos / mScrollPosState.rowHeight );
