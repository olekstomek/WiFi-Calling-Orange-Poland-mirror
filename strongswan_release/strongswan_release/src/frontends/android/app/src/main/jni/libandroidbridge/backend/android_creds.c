...
METHOD(android_creds_t, olp_add_shared_from_cert, void,
	private_android_creds_t *this, char *certAlias, char *password)
{
	...
	id = identification_create_from_string(certAlias);
...
android_creds_t *android_creds_create()
{
	...
	INIT(this,
		.public = {
			...
			.olp_add_shared_from_cert = _olp_add_shared_from_cert,
